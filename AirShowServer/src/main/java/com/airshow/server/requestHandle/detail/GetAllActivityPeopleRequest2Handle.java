...
public class GetAllActivityPeopleRequest2Handle extends RequestHandle {
    private static Logger logger = Logger.getLogger(GetAllActivityPeopleRequest2Handle.class);
	public GetAllActivityPeopleRequest2Handle(ChannelHandlerContext ctx,
                                              String contentStr) {
	...
	public String getHandleResult() {
        ...
        ResultSet rs=null;
		try {
			String sql = "select d.*,i.path as path from activity_people_2 d left join image i on d.image_id = i.id ";
            ...
            sql = "select count(*) from activity_people_2";
            ps = connection.prepareStatement(sql);
            rs = ps.executeQuery();
