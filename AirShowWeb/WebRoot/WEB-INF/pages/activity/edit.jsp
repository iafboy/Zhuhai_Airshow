		...
		<div class="row">
			...
			<div class="col-md-9" role="main">
				<div id="add">
					...
					<h2>添加活动</h2>
					<br />
					<form  class="form-horizontal" role="form" action="editCheck?id=${activity.id}" method="post" enctype="multipart/form-data">
    						...
    						<div class="col-sm-10">
								<select name="type" id="type" class="form-control">
                                    <c:if test="${activity.type == 1}">
                                        <option value="1" selected="selected">媒体日</option>
                                        <option value="2">现场报道</option>
                                        <option value="3">活动排期</option>
                                    </c:if>
                                    <c:if test="${activity.type == 2}">
                                        <option value="1">媒体日</option>
                                        <option value="2" selected="selected">现场报道</option>
                                        <option value="3">活动排期</option>
                                    </c:if>
                                    <c:if test="${activity.type == 3}">
                                        <option value="1">媒体日</option>
                                        <option value="2">现场报道</option>
                                        <option value="3" selected="selected">活动排期</option>
                                    </c:if>
                                </select>
							</div> 
						</div>
                        ...
                        <div class="form-group">    
    						...
    						<div class="col-sm-10">
								<textarea id="introduction" class="form-control" name="introduction" rows="13" style="text-align: left">${activity.introduction}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="time" name="time" value="${activity.time}">
                            </div>
                        </div>
