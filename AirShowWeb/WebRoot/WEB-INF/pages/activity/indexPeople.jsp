    ...
    <div class="row">
        <div class="col-md-3">
            <div class="bs-sidebar hidden-print affix" role="complementary">
                <ul class="nav bs-sidenav">
                    ...
                    <li class="active"><a href="../activity/indexPeople">查看活动人员</a></li>
        ...
        <div class="col-md-9" role="main">
                ...
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <c:forEach items="${activityList}" var="activity">
                        <tr>
                            <td>${activity.id}</td>
                            <td>
                            <c:if test="${activity.type == 1}">个人</c:if>
                            <c:if test="${activity.type == 2}">团体</c:if>
                            </td>
                            <td>${activity.name}</td>
			...
			<div style="text-align: center">
                <ul class="pagination">
                    <li id="pre"><a href="indexPeople?type=${type}&&page_id=${prePage}">&laquo;</a></li>
                    <li class="active"><a href="#">${curPage}</a></li>
                    <li id="las"><a href="indexPeople?type=${type}&&page_id=${lasPage}">&raquo;</a></li>
                </ul>
