		...
		<div class="row">
			<div class="col-md-3">
				<div class="bs-sidebar hidden-print affix" role="complementary">
					<ul class="nav bs-sidenav">
                        ...
                        <li class="active"><a href="../activity/uploadExcelPeopleImage">导入活动图片信息</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="col-md-9" role="main">
				<div id="add">
					...
					<h2>上传Excel</h2>
					<br />
					<form class="form-horizontal" role="form" action="uploadExcelPeopleImageCheck" method="post" enctype="multipart/form-data">
