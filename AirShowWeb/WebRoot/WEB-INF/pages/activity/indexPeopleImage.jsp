    ...
    <div class="row">
        <div class="col-md-3">
            <div class="bs-sidebar hidden-print affix" role="complementary">
                <ul class="nav bs-sidenav">
                    ...
                    <li class="active"><a href="../activity/indexPeopleImage">查看活动图片</a></li>
        ...
        <div class="col-md-9" role="main">
                ...
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <c:forEach items="${activityList}" var="activity">
                        <tr>
                            ...
                            <td>${activity.image_introduction}</td>
                            <td>
			...
			<div style="text-align: center">
                <ul class="pagination">
                    <li id="pre"><a href="indexPeopleImage?type=${type}&&page_id=${prePage}">&laquo;</a></li>
                    <li class="active"><a href="#">${curPage}</a></li>
                    <li id="las"><a href="indexPeopleImage?type=${type}&&page_id=${lasPage}">&raquo;</a></li>
                </ul>
...
<script>
    $(function(){
        ...
        $("#type").change(function(){
            window.location.href = "indexpeople?type=" + $("#type").val();
        });
    })
</script>
</body>
