                ...
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <c:forEach items="${pavilionList}" var="pavilion">
                        <tr>
                            <td>${pavilion.id}</td>
                            <td>${pavilion.name}</td>
                            <td>${pavilion.introduction}</td>
                            <td>
                                <button onclick="editPavilion(${pavilion.id})" class="btn btn-danger" type="button">编辑
                                </button>
                                <button onclick="deletePavilion(${pavilion.id})" class="btn btn-danger" type="button">删除
                                </button>
                            </td>
                        </tr>
                    </c:forEach>
