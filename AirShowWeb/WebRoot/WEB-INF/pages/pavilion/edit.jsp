		...
		<div class="row">
			<div class="col-md-3">
				<div class="bs-sidebar hidden-print affix" role="complementary">
					<ul class="nav bs-sidenav">
                    	<li class="active"><a href="../pavilion/index">查看展馆</a></li>
                    	<li><a href="../pavilion/add">添加展馆</a></li>
			...
			<div class="col-md-9" role="main">
				<div id="add">
					...
					<h2>编辑展馆</h2>
					<br />
					<form class="form-horizontal" role="form" action="editCheck?id=${user.id}" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">名字</label>
    						<div class="col-sm-10">
								<input type="text" class="form-control" id="name" name="name" value="${pavilion.name}">
							</div>
                        </div>

                        <c:if test="${path != null}">
                            <label for="name" class="col-sm-2 control-label">原有图片</label>
                            <div class="form-group">
                        ...
                        <div class="form-group">	
    						...
    						<div class="col-sm-10">
								<textarea class="form-control" id="introduction" name="introduction" rows="5">${pavilion.introduction}</textarea>
							</div>
                        </div>
