				...
				<div id="add">
					...
					<form class="form-horizontal" role="form" >	
						...
						<div class="form-group">
	    					...
	    					<div class="col-sm-11">
								<input type="text" class="form-control" id="title" name="title" value="${news.title}" readonly="readonly">
	                        </div>
						</div>
	                    ...
	                    <div class="form-group">    
	    					...
	    					<div class="col-sm-11"> 
								<textarea id="introduction" class="form-control" name="introduction" readonly="readonly" rows="8" style="text-align: left">${news.introduction}</textarea>
							</div>
						</div>
						
						<c:if test="${news.path!=null}">
							<div class="form-group">
								<label for="introduction" class="col-sm-1 control-label">图片</label>
	    						<div class="col-sm-11"> 
	                        		<img src="..${news.path}" style="height:200px" />
	                        	</div>
	                        </div>
						</c:if>
					</form>
                   <br />
                	<h3><a href="../news/delete?id=${news.id}">删除新闻</a></h3>
