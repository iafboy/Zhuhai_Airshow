    ...
    <div class="container">
        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse"
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="../document/index">档案管理</a></li>
        ...
        <div class="col-md-3">
            <div class="bs-sidebar hidden-print affix" role="complementary">
                <ul class="nav bs-sidenav">
                    <li class="active"><a href="../document/index">查看档案</a></li>
                    <li><a href="../document/uploadExcel">excel导入</a></li>
                </ul>
            </div>
        </div>
