        ...
        <div class="col-md-9" role="main">
            <div id="basic">
                ...
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody id="user_list">
                    <c:forEach items="${businessmanList}" var="user">
                        <tr>
                            <td>${user.id}</td>
                            <td>${user.pavilion_id}</td>
                            <td>${user.phone}</td>
                            <td>${user.name}</td>
                            <td>${user.email}</td>
                            <td>
                                <button onclick="checkUser(${user.id})" class="btn btn-danger" type="button">查看</button>
                                <button onclick="editUser(${user.id})" class="btn btn-danger" type="button">编辑</button>
                                <button onclick="deleteUser(${user.id})" class="btn btn-danger" type="button">删除</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
